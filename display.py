...
def show_footer():
    ...
    time.sleep(0.1)
    # The wave leaves the text, clearing out the colors cleanly to finish the sequence
    console.print("made [#0EE3D8]b[/][#85FF00]y[/] [#E9D502]a[/][#F8C000]r[/]y", end="\r")
    time.sleep(0.1)
    console.print("made b[#0EE3D8]y[/][#85FF00]a[/]ry", end="\r")
    time.sleep(0.1)

    # Final clean frame (no end="\r" here so the terminal cursor moves to the next line safely)
    console.print("made by ary")
